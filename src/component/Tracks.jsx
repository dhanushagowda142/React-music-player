...
function Tracks(){
    ...
    return(
        <div className="container-fluid bg-dark mt-5" id="track">
            <div className="row">
                <div className="col-md-12 text-center">
                    <h3 className="display-4 text-light mt-4">Music Tracks</h3>
                            ...
                            <div className="col-lg-3 col-md-4 col-sm-6 mt-2 mb-2" key={index}>
                                <div className="card music-card" onClick={() => trackClick(item)}>
                                    ...
                                    <div className="card-hover">
                                        <h6 className="text-light text-center">{name}</h6>
                                    </div>
                                </div>
                            </div>
                        )
                                  ...
                                  <div className="container">
                                       <div className="row">
                                          <div className="col-md-12">
                                              <button className="btn-close text-light justify-content-end" onClick={()=>close()}>
                                              </button>
                                          </div>
                                        </div>
                                        <div className="row">
                                              <div className="col-md-4">
                                                  <div className="img">
                                                     <img src={track?.album.images[0].url} alt="" className="img-fluid rounded-circle" width={120} height={120} />
                                                  </div>     
                                               </div>
                                               <div className="col-md-6">
                                                  <h6 className="text-center  mt-4">{track?.name}</h6>
